...
pastEvents.set("25/10/00",`
    <div class="event" id="codeshield">
        <div class="before">
            <h3>Codeshield Workshop with Medisec - October 2025</h3>
            </div>
        <div class="after">
            <h3>Codeshield Workshop with Medisec - October 2025</h3>
            <p>Details: </p>
            <ul>
                <li>Explored the intersection of cybersecurity & healthcare over 2 weekends </li>
                <li>Conducted several coding activities and interactive investigations  </li>
                <li>Organised & managed workshop logistics efficiently  </li>
            </ul>

            <p>Impact: </p>
            <ul>
                <li>Participants developed foundational skills in digital software & python </li>
                <li>Created a supportive learning environment for beginners to collaborate </li>
                <li>Achieved over 140 likes and several comments on Instagram posts & reels </li>
                <li>Engaged 10+ attendees with keen interest in the workshop </li>
            </ul>
        </div>`); 
pastEvents.set("25/08/00",`<div class="event" id="lumora"><div class="before"><h3>Joint Post with Lumora - August 2025</h3></div></div>`); 
pastEvents.set("25/07/00",`<div class="event" id="STEMHER"><h3>Joint Post with with STEMHER - July 2025</h3></div>`); 
pastEvents.set("25/02/00",`<div class="event" id="nextGenTechWorkshop"><h3>Next Gen Tech Workshop Collab - February 2025</h3></div>`); 
pastEvents.set("25/01/00",`<div class="event" id="pinkGap2"><h3>Pinkgap Medicine Conference II - January 2025</h3></div>`); 
pastEvents.set("24/11/00",`<div class="event" id="pinkGap"><h3>Hour of Code Workshop with Pinkgap - November 2024</h3></div>`); 
...
<div class="event" id ="eventid">
    <div class="before">
        <h3> Title of event - date </h3>
        <p> desc of event & impact </p>
        </div>

    <div class="after">
        <h3>Title of event - date </h3>
        <p>desc of event (in full) </p>
        other stuff
        </div>
    </div>
*/
